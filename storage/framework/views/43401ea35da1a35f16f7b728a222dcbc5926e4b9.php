<div class="left-sidebar">
    ...
    <div class="panel-group category-products" id="accordian"><!--category-productsr-->
        ...
        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4 class="panel-title"><a href="<?php echo e(URL::to('/products_by_category/'.$category->id)); ?>"><?php echo e($category->category_name); ?></a></h4>
                </div>
            </div>
        ...
        <div class="brands-name">
            <ul class="nav nav-pills nav-stacked">
                ...
                <?php $__currentLoopData = $manufactures; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $manufacture): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <li><a href="#"> <span class="pull-right">(50)</span><?php echo e($manufacture->manufacture_name); ?></a></li>
