...
@section('admin_content')
            ...
            <div class="box-content">
                <table class="table table-striped table-bordered bootstrap-datatable datatable">
                    ...
                    <tr>
                        ...
                        <td class="center">{{date('M j,Y H:i',strtotime($v_manufacture->created_at))}}</td>
                        <td class="center">{{$v_manufacture->created_by}}</td>
                        <td class="center">
                            <?php
                        ...
                        <td class="center">
                            ...
                            @if($v_manufacture->publication_status==1)
                                <a class="btn btn-success" href="{{URL::to('/manufacture_status/'.$v_manufacture->id)}}">
                                    <i class="halflings-icon white thumbs-up"></i>
                                </a>
                            @else
                                <a class="btn btn-danger" href="{{URL::to('/manufacture_status/'.$v_manufacture->id)}}">
                                    <i class="halflings-icon white thumbs-down"></i>
                                </a>
                            @endif

                            <a class="btn btn-info" href="{{URL::to('/update-manufacture/'.$v_manufacture->id)}}">
                                <i class="halflings-icon white edit"></i>
                            </a>
                            <a class="btn btn-danger" href="{{URL::to('/delete-manufacture/'.$v_manufacture->id)}}">
    ...
    <div class="row-fluid sortable">
        <div class="box span12">
            ...
            <div class="box-content">
                {!! Form::open(['url' => '/add_manufacture','method'=>'post','class'=>'form-horizontal']) !!}
                <fieldset>
